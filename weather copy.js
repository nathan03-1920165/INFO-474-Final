...
d3.select("#mySlider").on("input", function() {
    ...
    updateChart1(cityKey, selectedValue);    
    updateChart2(cityKey, selectedValue);
    updateChart3(cityKey, selectedValue);
    updateChart4(cityKey, selectedValue); 
...
// Resets slider value and slider text
function resetSliderValue() {
    var slider = d3.select('#mySlider');
    var defaultSliderValue = 0;
    slider.property('value', defaultSliderValue);

    var sliderValueText = d3.select('#sliderValue')
    var defaultSliderValueText = 'Actual Precipitation < ' + defaultSliderValue + ' in.';
    sliderValueText.text(defaultSliderValueText);
}
